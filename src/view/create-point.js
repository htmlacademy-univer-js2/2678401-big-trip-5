              ...
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  ...
                  <div class="event__field-group  event__field-group--time">
                    ...
                    <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${dateFrom ? parseFormatDate(dateFrom, TIME_FORMAT_LIST['FULL_DATE']) : ''}">
                    &mdash;
                    <label class="visually-hidden" for="event-end-time-1">To</label>
                    <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dateTo ? parseFormatDate(dateTo, TIME_FORMAT_LIST['FULL_DATE']) : ''}">
                  </div>
...
export default class CreatePointView extends AbstractStatefulView {
  ...
  #formHandlerSubmit = (evt) => {
    evt.preventDefault();
    this.#formHandler(CreatePointView.parseStateToPoint(this._state));
  };

  #deleteHandlerClick = (evt) => {
    evt.preventDefault();
    this.#deleteHandler(CreatePointView.parseStateToPoint(this._state));
  };
